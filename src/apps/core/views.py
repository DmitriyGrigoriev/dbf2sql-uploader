...
from .functions import tables_import_info_list, table_import_info
from .tasks import (
...
def run_import_for_single_table(request, table_pk, mode):
    ...
    t_list: ImportInfo = table_import_info(table_pk)
...
def run_import_for_database(request, poll_pk, mode) -> HttpResponseRedirect:
    ...
    t_list: ImportInfo = tables_import_info_list(poll_pk)
